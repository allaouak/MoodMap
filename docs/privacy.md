...
**Non collecté** : localisation, contacts, données biométriques brutes, identifiants publicitaires.
...
- **Export** : non encore implémenté. À prévoir pour conformité RGPD (droit à la portabilité).
...
| Portabilité | Non | À implémenter (export JSON/CSV) |
| Opposition | Non | À implémenter (opt-out IA) |
| Limitation | Non | À documenter |
...
- [ ] Implémenter l'export de données (portabilité)
